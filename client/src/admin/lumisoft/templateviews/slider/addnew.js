...
const SliderAddNewScreen = (props) => {
    ...
    const [subname] = useState(false);
    const [buttonlink] = useState(false);
    const [buttondestination] = useState(false);
...
export default SliderAddNewScreen;